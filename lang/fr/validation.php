...
return [
    ...
    */
    ...
    'ascii' => 'Le champ :attribute doit contenir uniquement des caractères alphanumériques de type simple et des symboles.',
    ...
    'doesnt_end_with' => 'Le champ :attribute ne peut pas se terminer avec l\'un des suivants: :values.',
    'doesnt_start_with' => 'Le champ :attribute ne peut pas commencer avec l\'un des suivants: :values.',
    'email' => 'Le champ :attribute doit être une adresse e-mail valide.',
    'ends_with' => 'Le champ :attribute doit se terminer par l\'un des suivants: :values.',
    'enum' => 'La valeur sélectionnée dans le champ :attribute est invalide.',
    'exists' => 'La valeur sélectionnée dans le champ :attribute est invalide.',
    ...
    'missing_with' => 'Le champ :attribute doit être manquant lorsqu\'un ou plusieurs des éléments :values sont présents.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le mot de passe fourni pour le champ :attribute a été utilisé dans une fuite de données. Veuillez choisir un nouveau mot de passe.',
    ],
    ...
    'prohibited_unless' => 'Le champ :attribute est prohibé à moins que :other soit dans :values.',
    'prohibits' => 'Le champ :attribute prohibe :other d\'être présent.',
    ...
    'unique' => 'La valeur choisie pour le champ :attribute a déjà été utilisée.',

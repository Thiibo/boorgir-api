    ...
    Route::get('/translations', function(){
        ...
        $translations = [
            "en" => [
                ...
                "backoffice.itemselection.action.editingredients" => "Edit",
                "backoffice.itemselection.ingredientsdialog.title" => "Edit ingredients for '%s'",
                "backoffice.itemselection.ingredientsdialog.currentitems" => "Current items:",
                "backoffice.itemselection.ingredientsdialog.add" => "Add",
                "backoffice.itemselection.ingredientsdialog.remove" => "Remove",
            ...
            "nl" => [
                ...
                "backoffice.itemselection.action.editingredients" => "Bijwerken",
                "backoffice.itemselection.ingredientsdialog.title" => "Ingrediënten bewerken voor '%s'",
                "backoffice.itemselection.ingredientsdialog.currentitems" => "Huidige items:",
                "backoffice.itemselection.ingredientsdialog.add" => "Toevoegen",
                "backoffice.itemselection.ingredientsdialog.remove" => "Verwijderen",
            ...
            "fr" => [
                ...
                "backoffice.itemselection.action.editingredients" => "Modifier",
                "backoffice.itemselection.ingredientsdialog.title" => "Modifier les ingrédients pour « %s »",
                "backoffice.itemselection.ingredientsdialog.currentitems" => "Articles courants :",
                "backoffice.itemselection.ingredientsdialog.add" => "Ajouter",
                "backoffice.itemselection.ingredientsdialog.remove" => "Supprimer",
